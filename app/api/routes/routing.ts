...
Route.group(() => {
  ...
  Route.get('/scraper/:name', 'ScraperController.getScrapeCsv').as('scraper.scrapeCsvData').middleware(['auth', 'role:admin,customer'])
  Route.delete('/scraper/:name', 'ScraperController.delScrapeCsv').as('scraper.delCsvData').middleware(['auth', 'role:admin,customer'])
